  ...
  return (
    <div className="flex items-center gap-1 justify-center h-full w-full min-w-0">
      <Button
        type="button"
        variant="compact"
        className="px-2 py-1 h-full flex-1 min-w-0"
      ...
      <input
        ...
        className="w-20 border rounded px-2 py-1 text-center focus:outline-none focus:ring-2 focus:ring-blue-300 transition bg-white h-full flex-shrink min-w-0"
        disabled={disabled}
        style={{ minWidth: '4rem' }}
      />
      <Button
      ...
      <Button
        type="button"
        variant="compact"
        className="ml-1 px-2 py-1 h-full flex-1 min-w-0"
        style={{ minWidth: '2.5rem' }}
        disabled={disabled}
